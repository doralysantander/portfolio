...
<input className='my-4 p-2  focus:outline-none focus:border-[#C39317] focus:ring-[#C39317] block w-full rounded-md sm:text-sm focus:ring-1 bg-[#fff]' type="email" placeholder='Email' name='email' invalid  required/>
